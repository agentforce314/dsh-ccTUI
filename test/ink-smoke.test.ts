// Stage 2 acceptance: the vendored @clawcodex/ink fork builds and renders headlessly.
...
describe('vendored @clawcodex/ink fork', () => {
  it('renders Box/Text synchronously into a fake TTY', async () => {
    const { Box, Text, renderSync } = await import('@clawcodex/ink')
