 ...
 *
 * Symptom: in `clawcodex --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@clawcodex/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using clawcodex --tui and as i type multiline my caret at the end will often ' +
