import { Box, type ScrollBoxHandle, stringWidth, Text } from '@dsh-cctui/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (DSH_CCTUI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (DSH_CCTUI_DEV_CREDITS), lowest priority,
