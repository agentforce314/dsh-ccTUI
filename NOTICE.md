...
Integration and packaging patterns for deepseek-harness plugins (bundle patch discipline,
adapter boundary, exit funnel, provider registration) are adapted from dsh-TUI.
...
This plugin consumes the published `@deepseek-ai/*` packages as peer dependencies. MIT License.
